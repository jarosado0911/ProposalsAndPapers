...
\subsection*{Calcium wave simulations}

\begin{itemize}
\item SG: Add thumbnails of simulation
\item SG/JR: Add table of computation time used on XSEDE Comet so far
\item SG: Add reference to dissertation 
\end{itemize}
